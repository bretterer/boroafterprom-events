...
<p>This email is to inform you that your student, {{$attendee->first_name}} {{ $attendee->last_name}} has NOT checked into our event. Our doors are now closed and they will not be admitted.</p>
