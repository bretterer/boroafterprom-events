...
<p><strong>Do I need money?</strong><br/>
No. All activities, food, and drink are free thanks to our fundraising and sponsors!</p>

<p><strong>How do I get to the South Metro Sports?</strong><br/>
You are responsible for your own transportation to and from South Metro Sports.</p>

<p><strong>What should I wear?</strong><br/>
Go home and change then come to AfterProm. We encourage comfortable and appropriate clothes AND SOCKS for the physical activities you can participate in while at AfterProm.</p>

<p><strong>Can I leave early or leave then come back?</strong><br/>
Yes, you may leave whenever you wish, but you may not reenter once you have left.</p>

<p><strong>Do I need a physical ticket for the event?</strong><br/>
No, you do not need a physical ticket, this email (or any prior emails) will act as your ticket. However, if you would like a physical ticket, click below.</p>
<p>Download ticket for: <a href="{{route('printTicket',$attendee->ticket->uuid)}}" target="_blank">{{$attendee->first_name}} {{$attendee->last_name}}</a></p>
@if ($attendee->guest)
<p>Download ticket for: <a href="{{route('printTicket',$attendee->guest->ticket->uuid)}}" target="_blank">{{$attendee->guest->first_name}} {{$attendee->guest->last_name}}</a></p>
@endif

<p><strong>Here is a tip</strong><br/>
Each attendee receives 50 raffle tickets to write their name on. Bringing labels or a name stamp helps immensely! Each Ticket is 1" Wide by 2" Long.</p>


<h3>Order Details</h3>
Order Reference: <strong>#{{ explode('-', $attendee->ticket->uuid)[0] }} @if($attendee->guest) & #{{ explode('-', $attendee->guest->ticket->uuid)[0] }}@endif</strong><br>
...
<p>Thank you and we look forward to seeing you at Afterprom!</p>
