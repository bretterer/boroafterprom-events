                    ...
                    <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
                        <div class="flex">
                            <div class="relative flex-grow focus-within:z-10">
                                ...
                                <input type="search" wire:model="search" name="search" id="desktop-search-candidate" class="w-full rounded-t-md  border-0 py-1.5 pl-10 text-sm leading-6 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400" placeholder="Search attendees">
                            </div>
